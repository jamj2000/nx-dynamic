...
export default async function Home({ searchParams }) {
  ...
  return (
    <section className="min-h-screen max-w-[1024px] mx-auto px-10">
      ...
      <form className='my-10 grid grid-cols-[100px_auto] gap-4'>

        <label htmlFor='nombre'>Nombre</label>
        <input id='nombre' name='nombre' className='p-1 border border-slate-200' />

        <label htmlFor='descripcion'>Descripcion:</label>
        <input id='descripcion' name='descripcion' className='p-1 border border-slate-200' />
